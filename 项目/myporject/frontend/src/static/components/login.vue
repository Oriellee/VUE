<template>
    <el-form ref="AccountFrom" :model="account" :rules="rules" label-position="left" label-width="0px"
        ...
        <el-form-item prop="username">
            <el-input type="text" v-model="account.username" prefix-icon="el-icon-search" auto-complete="off" placeholder="账号"></el-input>
        </el-form-item>
        <el-form-item prop="password">
            <el-input type="password" v-model="account.password" prefix-icon="el-icon-search" auto-complete="off" placeholder="密码"></el-input>
        </el-form-item>
